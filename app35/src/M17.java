...
class LinkedList
{
	...
	void swap(int data1,int data2)
	{
		...
		if(n1==null||n2==null)
		{
			//After both while loop if n1 or n2 is null then no need for swapping
			return;
		}
		if(first.i==data1)
		{	
		...
		{
			//swapping two reverse element(40,10)
			n2Prev.ref=n1;
			n1.ref=n2;
			n2.ref=n1Next;
		}
