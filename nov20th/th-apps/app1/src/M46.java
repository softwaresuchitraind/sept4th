class Shared
{
	...
	void test2(Shared obj)
	{
		...
		synchronized(this)
		{
			System.out.println("test2 syn begin by " +t1.getName());
			Util.sleep(100);
			synchronized(obj)
			{
...
nesting of synchonized block is not advisibale

a Thread withour relesing object log looking for a2 and a2 without 
releasing looking for a1.
*/